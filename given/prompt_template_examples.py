...
from prompt_template import PromptTemplate, FeynmanTemplate
...
# ============================================================================
# Example: Feynman Learning
# ============================================================================
print("\n" + "=" * 70)
print("EXAMPLE: Feynman Learning")
print("=" * 70)

prompt = FeynmanTemplate("Explain Quantum Computing")
prompt = prompt.with_feynman_learning("a high school student", num_rounds=2)
prompt = prompt.with_chain_of_thought()  
...
# ============================================================================
# Example: Feynman Learning (Knowledge Gap Focus)
# ============================================================================
print("\n" + "=" * 70)
print("EXAMPLE: Feynman Learning (Knowledge Gap Focus)")
print("=" * 70)

prompt = FeynmanTemplate("Explain Quantum Computing")
prompt = prompt.with_feynman_learning("a high school student", num_rounds=2)
prompt = prompt.with_knowledge_gap_focus(specific_gaps=["quantum probability"])
prompt = prompt.with_chain_of_thought()
